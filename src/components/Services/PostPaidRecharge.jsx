      ...
      <Box mt={4} p={4} boxShadow={2} bgcolor="#DDF1F5" borderRadius={8}>
        ...
        <Grid container spacing={4}>
          <Grid item xs={12} sm={6} style={{marginTop:"10%"}}>
            <Typography variant="h4" color="#0B12B7" gutterBottom sx={{ fontWeight: 'bold', fontSize:'35px' }}>
              Instant Postpaid Mobile Recharge Solution
            </Typography>
            <Typography variant="body1" gutterBottom sx={{fontSize:'20px', marginTop:'5%'}}>
              Empower your connectivity with seamless postpaid mobile recharges, where convenience meets innovation.
            </Typography>
          </Grid>
            ...
            <Box p={4} bgcolor="white" boxShadow={2} borderRadius={8}>
              ...
              <FormControl fullWidth margin="normal" error={formik.touched.operator && Boolean(formik.errors.operator)}>
                ...
                >
                  ...
                  <MenuItem value="Airtel Postpaid">Airtel Postpaid</MenuItem>
                  <MenuItem value="BSNL Postpaid">BSNL Postpaid</MenuItem>
                  <MenuItem value="Jio Postpaid">Jio Postpaid</MenuItem>
                  <MenuItem value="MTNL Postpaid">MTNL Postpaid</MenuItem>
                  <MenuItem value="Vi Postpaid">Vi Postpaid</MenuItem>
                  <MenuItem value="Tata Docomo Postpaid">Tata Docomo Postpaid</MenuItem>
                  <MenuItem value="Reliance Communications Postpaid">Reliance Communications Postpaid</MenuItem>
                </Select>
              </FormControl>
