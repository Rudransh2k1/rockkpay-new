...
import { menuAdminArray, menuChannelArray, menuDistriArray, menuMasterArray, menuRetailArray, menuSuperArray } from './data';
    ...
    <Box sx={{ display: 'flex', height: "100vh" }}>
      ...
      >
        ...
        <Divider />
        {
          ...
          </> : <>{userType === "Distributor" ? <><List sx={{ color: "white", backgroundColor: '#b49ce5', }}>
            {menuDistriArray.map((text, index) => (
              <MenuItem text={text} index={index} />
            ))}
          </List></> : <><List sx={{ color: "white", backgroundColor: '#b49ce5', }}>
